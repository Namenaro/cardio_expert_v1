...
class RBFSVMEvaluator(BaseEvaluator):
    ...
    def __init__(
            ...
            C: float = 1.0,  # параметр регуляризации (чем меньше, тем устойчивее к выбросам)
        ...
        self.svm = SVC(
            ...
            probability=probability,  # для получения калиброванных вероятностей
